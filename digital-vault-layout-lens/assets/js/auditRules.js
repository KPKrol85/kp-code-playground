...
export const auditRules = [
  { id: 'layout-landmarks', category: 'Layout structure', title: 'Page regions are easy to identify', description: 'Header, main content, navigation, side panels, and footer areas are visually and semantically clear.', severity: 'high' },
  ...
  { id: 'layout-overflow', category: 'Layout structure', title: 'Content avoids clipping and horizontal overflow', description: 'Long labels, cards, tables, and controls remain readable without unexpected sideways scrolling.', severity: 'high' },
  { id: 'responsive-mobile-layout', category: 'Responsive behavior', title: 'Mobile layout remains usable', description: 'The interface stacks cleanly on narrow screens and keeps primary actions reachable.', severity: 'high' },
  ...
  { id: 'responsive-content-reflow', category: 'Responsive behavior', title: 'Content reflows without losing meaning', description: 'Important labels, status text, and relationships still make sense after the layout changes.', severity: 'medium' },
  { id: 'accessibility-keyboard', category: 'Accessibility basics', title: 'Keyboard users can operate the UI', description: 'All interactive elements can be reached, used, and exited with a keyboard.', severity: 'high' },
  ...
  { id: 'content-headings', category: 'Content clarity', title: 'Headings describe the content below', description: 'Section titles and card headings are specific enough to support quick scanning.', severity: 'medium' },
