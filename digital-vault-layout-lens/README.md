...
4. Select **Prepare AI review** to build a session-only evidence snapshot from the reviewed deterministic Layout Lens data and bind it to the selected preset.
