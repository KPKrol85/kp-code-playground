...
systems.push(
  ...
  },
  {
    ...
    description: "Analityczny SaaS dla wzrostu z mocnym kolorem danych, lekkimi powierzchniami i wyraźnymi statusami.",
  ...
  },
  {
    ...
    name: "DevOps Monitor",
    category: "Dla devów",
    useCase: "Statusy deployów, health checks, pipeline CI i dashboardy infrastruktury",
    description: "DevOpsowy system monitoringu z ciemnym tłem, zielonym sukcesem i ostrym kolorem incydentu.",
    primaryAction: "Wdróż build",
    secondaryAction: "Sprawdź logi",
    tags: ["devops", "deploy", "monitoring"],
    colors: {
      background: "#0b1116",
      surface: "#121a22",
      surfaceRaised: "#1d2833",
      text: "#edf4f8",
      textMuted: "#a4b2bd",
      border: "#33414f",
      primary: "#22c55e",
  ...
  },
  {
    ...
    category: "Edukacja",
    useCase: "Quizy, testy kompetencji, wyniki egzaminów i oceny modułów",
    description: "System oceniania z jasnym rozróżnieniem stanów, mocnym kolorem postępu i lekką strukturą kart.",
    primaryAction: "Rozpocznij test",
    secondaryAction: "Zobacz wyniki",
    tags: ["quiz", "assessment", "results"],
    colors: {
      background: "#f8f9ff",
      surface: "#ffffff",
  ...
  },
  {
    ...
    description: "Raportowy system impact z jasnym papierowym tłem, spokojnym zielonym i mocnym akcentem danych.",
  ...
  },
  {
    ...
    description: "Executive enterprise z ciemnym atramentem, formalną typografią i ciepłym akcentem decyzji.",
  ...
  },
  {
    ...
    description: "Publiczny system civic z jasnymi powierzchniami, oficjalnym niebieskim i przyjaznym zielonym wsparciem.",
  ...
  },
  {
    ...
    description: "Operacyjny system produktywności z czytelnymi kartami, mocnym niebieskim i spokojnym tłem pracy.",
...
systems.push(
  {
    ...
    description: "Profesjonalny system publikacyjny z ostrzejszą strukturą panelu, neutralnym tłem i mocnym kolorem statusu.",
  ...
  },
  {
    ...
    description: "SaaS dla zespołów CS z czytelnym statusem kont, spokojnym błękitem i zielonym sygnałem zdrowia.",
  ...
  },
  {
    ...
    name: "Gallery Maison",
    category: "Marka",
    useCase: "Galerie sztuki, portfolio premium, showroomy i karty kolekcji",
    description: "Kameralny system galeryjny z ciemnym atramentem, miękkim szampanem i bardzo oszczędnymi akcentami.",
    primaryAction: "Zobacz ekspozycję",
    secondaryAction: "Umów pokaz",
    tags: ["gallery", "showroom", "art"],
    colors: {
      background: "#11100f",
      surface: "#1a1816",
  ...
  },
  {
    ...
    description: "Cyfrowy desk zdrowia z błękitnym CTA, klinicznym tłem i miękkimi stanami rozmowy.",
  ...
  },
  {
    ...
    name: "SDK Portal",
    category: "Dla devów",
    useCase: "Portale SDK, biblioteki integracji, changelogi techniczne i przykłady implementacji",
    description: "Jasny developer portal z kodowym akcentem, technicznym błękitem i bardzo czytelnymi blokami API.",
    primaryAction: "Pobierz SDK",
    secondaryAction: "Zobacz changelog",
    tags: ["sdk", "integration", "changelog"],
    colors: {
      background: "#f5f8fb",
      surface: "#ffffff",
  ...
  },
  {
    ...
    name: "Workshop Kit",
    category: "Edukacja",
    useCase: "Warsztaty online, materiały szkoleniowe, checklisty i zadania zespołowe",
    description: "Warsztatowy system edukacyjny z żywą zielenią, miękkim tłem i czytelnymi modułami pracy.",
    primaryAction: "Start warsztatu",
    secondaryAction: "Pobierz materiały",
    tags: ["workshop", "training", "materials"],
    colors: {
      background: "#f6fbf8",
      surface: "#ffffff",
      surfaceRaised: "#e8f4ed",
      text: "#1d2a24",
      textMuted: "#5f6f66",
      border: "#cfe0d6",
      primary: "#2f8a5f",
  ...
  },
  {
    ...
    description: "Enterprise procurement z formalnym układem, chłodnym granatem i dyskretnym akcentem finansowym.",
  ...
  },
  {
    ...
    description: "Operacyjny system najmu z neutralnymi kartami, zielonym statusem umowy i jasnymi alertami płatności.",
  ...
  },
  {
    ...
    description: "Społeczny system koordynacji z jasną zielenią, przyjaznym pomarańczem i przejrzystymi statusami.",
  ...
  },
  {
    ...
    description: "Zespołowy system workflow z neutralną bazą, mocnym granatem i zielonym stanem zakończenia.",
...
systems.push(
  {
    ...
    description: "Operacyjny system treści z czytelną hierarchią statusów, spokojnym tłem i akcentem gotowym pod workflow publikacji.",
  ...
  },
  {
    ...
    description: "Produktowy system SaaS dla zespołów growth z wyraźnym CTA, czytelnymi kartami segmentów i spokojnym kolorem analitycznym.",
  ...
  },
  {
    ...
    name: "Atelier Launch",
    category: "Marka",
    useCase: "Premiery kolekcji, strony atelier i ekskluzywne zapisy klientów",
    description: "Markowy system premium z jasnym papierowym tłem, atramentowym tekstem i precyzyjnym miedzianym akcentem.",
    primaryAction: "Zobacz kolekcję",
    secondaryAction: "Umów konsultację",
    tags: ["atelier", "launch", "premium"],
    colors: {
      background: "#f8f4ed",
      surface: "#ffffff",
      surfaceRaised: "#eee4d7",
      text: "#221d18",
      textMuted: "#6f6255",
      border: "#dccdb9",
      primary: "#7a5135",
  ...
  },
  {
    ...
    description: "Kliniczny system operacyjny dla szybkiej kwalifikacji z czytelnymi alertami i spokojnym medycznym tłem.",
  ...
  },
  {
    ...
    name: "Build Pipeline",
    category: "Dla devów",
    useCase: "Panele buildów, kolejki CI, artefakty wydań i statusy środowisk",
    description: "Techniczny system dla pipeline z ciemną bazą, niebieskim sygnałem wykonania i zielonymi stanami powodzenia.",
    primaryAction: "Uruchom build",
    secondaryAction: "Zobacz logi",
    tags: ["ci", "pipeline", "release"],
    colors: {
      background: "#0c1118",
      surface: "#121a24",
      surfaceRaised: "#1d2734",
      text: "#edf4fb",
      textMuted: "#a3b0bd",
      border: "#334253",
      primary: "#4da3ff",
      primaryHover: "#2f88e6",
      primaryContrast: "#07111c",
      secondary: "#34d399",
      accent: "#f5a524",
      success: "#34d399",
      warning: "#f5a524",
  ...
  },
  {
    ...
    description: "Kreatywny system pracy koncepcyjnej z czystym płótnem, mocnym różem i chłodnym kontrapunktem narzędziowym.",
  ...
  },
  {
    id: "91",
    file: "tokens-91.css",
    name: "Cohort Classroom",
    category: "Edukacja",
    useCase: "Programy cohort-based, sesje live, zadania grupowe i postępy mentorów",
    description: "Edukacyjny system kohortowy z przyjazną hierarchią modułów, czytelnym postępem i energetycznym kolorem sesji.",
    primaryAction: "Dołącz do sesji",
    secondaryAction: "Zobacz zadania",
    tags: ["cohort", "classroom", "mentoring"],
    colors: {
      background: "#f7f9fd",
      surface: "#ffffff",
      surfaceRaised: "#eaf0fb",
      text: "#1d2635",
      textMuted: "#637083",
      border: "#d6e0ee",
      primary: "#3b63b8",
  ...
  },
  {
    ...
    description: "System zrównoważonego łańcucha dostaw z naturalną zielenią, stalowym kontrastem i statusem odzysku.",
  ...
  },
  {
    ...
    description: "Formalny system governance z oszczędnym granatem, neutralnymi powierzchniami i mocną strukturą decyzji.",
  ...
  },
  {
    ...
    description: "Techniczny system AI dla runtime z jasnymi metrykami, spokojnym indygo i czytelnymi stanami jakości.",
  ...
  },
  {
    ...
    description: "Profesjonalny system nieruchomości komercyjnych z neutralną bazą, zielonym statusem i akcentem negocjacji.",
  ...
  },
  {
    ...
    description: "Społeczny system grantowy z jasną bazą, wiarygodną zielenią i akcentem dla etapów oceny.",
  ...
  },
  {
    ...
    description: "Produktywnościowy system decyzji z neutralnym rytmem pracy, mocnym granatem i wyraźnym stanem zamknięcia.",
