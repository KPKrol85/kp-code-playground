...
self.addEventListener("fetch", (event) => {
  ...
  // Do not cache non-GET or non-critical cross-origin requests.
  ...
  // HTML: network-first, then cache, then offline fallback.
  if (isHTML) {
    event.respondWith(
      fetch(req)
        .then((res) => {
  ...
  // Same-origin non-static GET requests: network only.
